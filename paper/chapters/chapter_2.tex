...
\textbf{Ridge regularization} \citep{hoerl_ridge_1970,hoerl_ridge_1970-1} uses $\text{pen}(\btheta) = \|\btheta\|_2^2$ and the Bayesian analogue \Citep[e.g.]{hhsiang_bayesian_1975,mackay_bayesian_1992,maccul} specifies
...
The Bayesian answer to this is the \textit{posterior predictive distribution} \Citep[see e.g]{barbieri_posterior_2015}
...
\footnotetext{
    A note on intuition: In essence, the posterior predictive distribution is the marginal distribution of $\ty$, conditioned on the data $\by$.

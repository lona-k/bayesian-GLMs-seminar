...
\begin{abstract}
  ...
  Using synthetic data, we evaluated predictive performance and variable selection accuracy in low-information scenarios under different priors and compared different methods for posterior inference.
\end{abstract}

...
(TODO: relevant? -> Anhang bzw. Diskussion)
...
TODO: Bild mti decision boundard? Lieber nicht ...
...
- **Lasso**: Prior hat keine geschlossene Form, aus der Posterior kann aber einfach mit Gibbs-Sampling simuliert werden [@park_bayesian_2008]
...
$\to$ **Approximative bayesianische Inferenz**, um aus der Posterior zu samplen, mit z.B.:
...
## *Beispiel 2:* Vergleich von approximativen Inferenz Methoden
...
## *Beispiel 2:* LA vs. Metropolis-Hastings
...
Für das bayesianische **logistische Modell** berechnet man $$p(\ty = 1 \mid \by)$$ mit $y_i \in \{0 \text{ (negative)}, 1 \text{ (positive)}\}$

...
- Bayesianisch: Laplace-Prior oder nach @park_bayesian_2008
$$
\begin{aligned}
...
<!-- In summary, Bayesian regression not only gives us uncertainty estimates, but also naturally incorporates regularization (no need for separate tuning of λ) and allows more flexible modeling through priors. -->

:::{.block}
### Fazit
- Sind bayesianische GLMs "besser" als frequentistische?

- Anwendungsmöglichkeiten: kleine Stichproben, Explizite Nutzung von Vorwissen
...
![Contour plot representing the sum of squared residuals, classical lasso constraint region (left), bivariate lasso prior and posterior distribution (right), and the classical and Bayesian penalized point estimates. Aus @van_erp_shrinkage_2019](../figures/van_erp_fig2_lasso.jpg){height='85%'}

# Regularisierung: Spike and Slab und Horseshoe Prios

- Spike and Slab: Idee + quote
- Horseshoe: Idee + quote

TODO: add them to the plot, show the plot here :)

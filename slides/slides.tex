...
\protect\phantomsection\label{visualisierung-der-prior-verteilungen}
\includegraphics[width=\linewidth,height=0.7\textheight,keepaspectratio]{../figures/plot_priors1.png}
\end{frame}
...
\protect\phantomsection\label{inferenz-der-parameter-posterior}
\textbf{Erinnerung}
...
\protect\phantomsection\label{exakte-inferenz-mit-konjugierten-priors}
...
\protect\phantomsection\label{posterior-update-fuxfcr-prior-verteilungen}
...
\protect\phantomsection\label{beispiel-vergleich-von-regularisierungs-priors-in-linearer-und-logistischer-regression}
